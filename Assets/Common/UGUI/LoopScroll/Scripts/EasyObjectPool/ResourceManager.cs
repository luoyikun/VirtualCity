...
namespace SG
{
    ...
    public class ResourceManager : MonoBehaviour
    {
        ...
        public void InitPoolByTmp(GameObject obj, int size, PoolInflationType type = PoolInflationType.DOUBLE)
        {
            ...
            {
                //GameObject pb = PublicFunc.CreateTmp(obj);
                //if (pb == null)
                //{
                //    Debug.LogError("[ResourceManager] Invalide prefab name for pooling :" + poolName);
                //    return;
                //}
                poolDict[poolName] = new Pool(poolName, obj, gameObject, size, type);
            }
        }
