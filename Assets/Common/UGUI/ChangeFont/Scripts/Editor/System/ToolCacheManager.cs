...
namespace BlueToolkit
{
    public class ToolCacheManager
    {
        ...
        public static void SaveFont(Font font)
        {
            ...
            AssetDatabase.CreateAsset(data, "Assets/Common/UGUI/ChangeFont/FontData.asset");
        }

        public static Font GetFont()
        {
            FontData data = AssetDatabase.LoadAssetAtPath<FontData>("Assets/Common/UGUI/ChangeFont/FontData.asset");
