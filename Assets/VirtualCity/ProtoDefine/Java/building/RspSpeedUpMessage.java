...
@MessageMeta(module = Modules.BULIDING,cmd = BuildingDataPool.RSP_SPEEDUP)
public class RspSpeedUpMessage extends Message {
    ...
    public RspSpeedUpMessage(int code, String tip) {
        this.code = code;
        this.tip = tip;
    }

    public RspSpeedUpMessage(Devlopments devlopments, int gold, int diamend, int code, String tip) {
        this.devlopments = devlopments;
        this.gold = gold;
        this.diamend = diamend;
        this.code = code;
