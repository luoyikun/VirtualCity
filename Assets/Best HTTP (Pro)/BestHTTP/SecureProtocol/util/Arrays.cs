...
namespace Org.BouncyCastle.Utilities
{
    ...
    public abstract class Arrays
    {
        ...
        public static BigIntegerHttp[] CopyOf(BigIntegerHttp[] data, int newLength)
        {
            BigIntegerHttp[] tmp = new BigIntegerHttp[newLength];
            Array.Copy(data, 0, tmp, 0, System.Math.Min(newLength, data.Length));
            return tmp;
        }
        ...
        public static BigIntegerHttp[] CopyOfRange(BigIntegerHttp[] data, int from, int to)
        {
            int newLength = GetLength(from, to);
            BigIntegerHttp[] tmp = new BigIntegerHttp[newLength];
            Array.Copy(data, from, tmp, 0, System.Math.Min(newLength, data.Length - from));
