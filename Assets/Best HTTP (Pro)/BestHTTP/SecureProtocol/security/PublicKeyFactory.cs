...
namespace Org.BouncyCastle.Security
{
    public sealed class PublicKeyFactory
    {
        ...
        public static AsymmetricKeyParameterHttp CreateKey(
            byte[] keyInfoData)
        {
            return CreateKey(
                SubjectPublicKeyInfoHttp.GetInstance(
        ...
        public static AsymmetricKeyParameterHttp CreateKey(
            SubjectPublicKeyInfoHttp keyInfo)
        {
                ...
                || algOid.Equals(PkcsObjectIdentifiers.IdRsaesOaep))
            {
                ...
                return new RsaKeyParametersHttp(false, pubKey.Modulus, pubKey.PublicExponent);
            }
            else if (algOid.Equals(X9ObjectIdentifiers.DHPublicNumber))
            {
                ...
                BigIntegerHttp y = dhPublicKey.Y.Value;
                ...
                BigIntegerHttp p = dhParams.P.Value;
                BigIntegerHttp g = dhParams.G.Value;
                BigIntegerHttp q = dhParams.Q.Value;

                BigIntegerHttp j = null;
                if (dhParams.J != null)
                {
                    j = dhParams.J.Value;
                }
                ...
                if (dhValidationParms != null)
                {
                    ...
                    BigIntegerHttp pgenCounter = dhValidationParms.PgenCounter.Value;
            ...
            else if (algOid.Equals(CryptoProObjectIdentifiers.GostR3410x2001))
            {
                ...
                ECPoint q = ecP.Curve.CreatePoint(new BigIntegerHttp(1, x), new BigIntegerHttp(1, y));
            ...
            else if (algOid.Equals(CryptoProObjectIdentifiers.GostR3410x94))
            {
                ...
                BigIntegerHttp y = new BigIntegerHttp(1, keyBytes);
        ...
        private static bool IsPkcsDHParam(Asn1Sequence seq)
        {
            ...
            return l.Value.CompareTo(BigIntegerHttp.ValueOf(p.Value.BitLength)) <= 0;
        }

        private static DHPublicKeyParameters ReadPkcsDHParam(DerObjectIdentifier algOid,
            BigIntegerHttp y, Asn1Sequence seq)
        {
            DHParameter para = new DHParameter(seq);

            BigIntegerHttp lVal = para.L;
