...
namespace Org.BouncyCastle.Crypto.Signers
{
    ...
    public class ECDsaSigner
        : IDsa
    {
        private static readonly BigIntegerHttp Eight = BigIntegerHttp.ValueOf(8);
        ...
        public virtual BigIntegerHttp[] GenerateSignature(byte[] message)
        {
            ...
            BigIntegerHttp e = CalculateE(n, message);
        ...
        public virtual bool VerifySignature(byte[] message, BigIntegerHttp r, BigIntegerHttp s)
        {
            ...
            BigIntegerHttp e = CalculateE(n, message);
            BigIntegerHttp c = s.ModInverse(n);

            BigIntegerHttp u1 = e.Multiply(c).Mod(n);
            BigIntegerHttp u2 = r.Multiply(c).Mod(n);
            ...
            if (curve != null)
            {
                BigIntegerHttp cofactor = curve.Cofactor;
            ...
            BigIntegerHttp v = point.Normalize().AffineXCoord.ToBigInteger().Mod(n);
            return v.Equals(r);
        }
        ...
        protected virtual BigIntegerHttp CalculateE(BigIntegerHttp n, byte[] message)
        {
            ...
            BigIntegerHttp trunc = new BigIntegerHttp(1, message);
