...
namespace Org.BouncyCastle.Crypto.Signers
{
        ...
        :   ISigner
    {
        ...
        private RsaKeyParametersHttp            kParam;
        ...
        public virtual byte[] GenerateSignature()
        {
            ...
            BigIntegerHttp t = new BigIntegerHttp(1, cipher.ProcessBlock(block, 0, block.Length));
            ClearBlock(block);
        ...
        public virtual bool VerifySignature(byte[] signature)
        {
            ...
            BigIntegerHttp t = new BigIntegerHttp(1, block);
            BigIntegerHttp f;
