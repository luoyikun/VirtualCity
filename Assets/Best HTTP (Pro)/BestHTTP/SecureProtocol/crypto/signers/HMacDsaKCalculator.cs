...
namespace Org.BouncyCastle.Crypto.Signers
{
        ...
        :   IDsaKCalculator
    {
        ...
        public void Init(BigIntegerHttp n, BigIntegerHttp d, byte[] message)
        {
            this.n = n;
            ...
            BigIntegerHttp mInt = BitsToInt(message);
        ...
        private BigIntegerHttp BitsToInt(byte[] t)
        {
            BigIntegerHttp v = new BigIntegerHttp(1, t);
