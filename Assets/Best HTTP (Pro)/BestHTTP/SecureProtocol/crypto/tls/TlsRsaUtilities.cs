...
namespace Org.BouncyCastle.Crypto.Tls
{
    public abstract class TlsRsaUtilities
    {
        ...
        public static byte[] GenerateEncryptedPreMasterSecret(TlsContext context, RsaKeyParametersHttp rsaServerPublicKey,
            Stream output)
        {
            /*
        ...
        public static byte[] SafeDecryptPreMasterSecret(TlsContext context, RsaKeyParametersHttp rsaServerPrivateKey,
