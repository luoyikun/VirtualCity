...
namespace Org.BouncyCastle.Crypto.Tls
{
    ...
    {
        internal static readonly BigIntegerHttp Two = BigIntegerHttp.Two;
        ...
        {
            BigIntegerHttp p = FromHex(hexP), q = p.ShiftRight(1);
        ...
        public static AsymmetricCipherKeyPairHttp GenerateDHKeyPair(SecureRandom random, DHParameters dhParams)
        {
        ...
        {
            AsymmetricCipherKeyPairHttp kp = GenerateDHKeyPair(random, dhParams);
        ...
        public static BigIntegerHttp ReadDHParameter(Stream input)
        {
            return new BigIntegerHttp(1, TlsUtilities.ReadOpaque16(input));
        }

        public static void WriteDHParameter(BigIntegerHttp x, Stream output)
        {
