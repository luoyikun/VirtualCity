...
namespace Org.BouncyCastle.Crypto.Tls
{
    ...
    {
        protected AsymmetricKeyParameterHttp mServerPublicKey = null;

        protected RsaKeyParametersHttp mRsaServerPublicKey = null;
        ...
        public override void ProcessServerCertificate(Certificate serverCertificate)
        {
            ...
            SubjectPublicKeyInfoHttp keyInfo = x509Cert.SubjectPublicKeyInfo;
            try
            {
            ...
            this.mRsaServerPublicKey = ValidateRsaPublicKey((RsaKeyParametersHttp)this.mServerPublicKey);
        ...
        protected virtual RsaKeyParametersHttp ValidateRsaPublicKey(RsaKeyParametersHttp key)
        {
