...
namespace Org.BouncyCastle.Crypto.Tls
{
        ...
        :   AbstractTlsSigner
    {
        ...
        public override ISigner CreateSigner(SignatureAndHashAlgorithm algorithm, AsymmetricKeyParameterHttp privateKey)
        {
            return MakeSigner(algorithm, false, true, new ParametersWithRandom(privateKey, this.mContext.SecureRandom));
        }

        public override ISigner CreateVerifyer(SignatureAndHashAlgorithm algorithm, AsymmetricKeyParameterHttp publicKey)
        {
            return MakeSigner(algorithm, false, false, publicKey);
        }

        public override bool IsValidPublicKey(AsymmetricKeyParameterHttp publicKey)
        {
            return publicKey is RsaKeyParametersHttp && !publicKey.IsPrivate;
        }
