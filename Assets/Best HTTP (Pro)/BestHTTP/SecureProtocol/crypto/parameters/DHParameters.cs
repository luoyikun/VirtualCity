...
namespace Org.BouncyCastle.Crypto.Parameters
{
		...
		: ICipherParameters
    {
		...
		private readonly BigIntegerHttp p, g, q, j;
			...
			DHValidationParameters	validation)
		{
			...
			if (g.CompareTo(BigIntegerHttp.Two) < 0
				|| g.CompareTo(p.Subtract(BigIntegerHttp.Two)) > 0)
			...
			if (j != null && j.CompareTo(BigIntegerHttp.Two) < 0)
