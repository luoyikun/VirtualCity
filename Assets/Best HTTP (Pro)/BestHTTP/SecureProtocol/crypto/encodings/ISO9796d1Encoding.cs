...
namespace Org.BouncyCastle.Crypto.Encodings
{
	...
	*/
	...
	{
		private static readonly BigIntegerHttp Sixteen = BigIntegerHttp.ValueOf(16);
		...
		private BigIntegerHttp modulus;
		...
		{
			RsaKeyParametersHttp kParam;
			if (parameters is ParametersWithRandom)
			{
				ParametersWithRandom rParam = (ParametersWithRandom)parameters;
				kParam = (RsaKeyParametersHttp)rParam.Parameters;
			}
			else
			{
				kParam = (RsaKeyParametersHttp)parameters;
			}
		...
		*/
			...
			int		inLen)
		{
			...
			BigIntegerHttp iS = new BigIntegerHttp(1, block);
			BigIntegerHttp iR;
