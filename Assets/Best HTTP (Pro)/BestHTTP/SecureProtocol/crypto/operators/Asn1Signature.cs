...
namespace Org.BouncyCastle.Crypto.Operators
{
	...
	public class Asn1SignatureFactory: ISignatureFactory
	{
        ...
        private readonly AsymmetricKeyParameterHttp privateKey;
		...
		public Asn1SignatureFactory (string algorithm, AsymmetricKeyParameterHttp privateKey): this(algorithm, privateKey, null)
		{
		}
		...
		public Asn1SignatureFactory (string algorithm, AsymmetricKeyParameterHttp privateKey, SecureRandom random)
		{
	...
	{
		private readonly AlgorithmIdentifier algID;
        private readonly AsymmetricKeyParameterHttp publicKey;
        ...
        public Asn1VerifierFactory (String algorithm, AsymmetricKeyParameterHttp publicKey)
		{
			DerObjectIdentifier sigOid = X509Utilities.GetAlgorithmOid (algorithm);
		...
		public Asn1VerifierFactory (AlgorithmIdentifier algorithm, AsymmetricKeyParameterHttp publicKey)
		{
            this.publicKey = publicKey;
	...
	public class Asn1VerifierFactoryProvider: IVerifierFactoryProvider
	{
		...
		public Asn1VerifierFactoryProvider(AsymmetricKeyParameterHttp publicKey)
		{
			this.publicKey = publicKey;
		}
