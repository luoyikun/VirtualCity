...
namespace Org.BouncyCastle.Math.Field
{
    ...
    {
        internal static readonly IFiniteField GF_2 = new PrimeField(BigIntegerHttp.ValueOf(2));
        internal static readonly IFiniteField GF_3 = new PrimeField(BigIntegerHttp.ValueOf(3));
    ...
    //    }
        ...
        public static IFiniteField GetPrimeField(BigIntegerHttp characteristic)
        {
