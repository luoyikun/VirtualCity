...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
        ...
        : AbstractF2mCurve
    {
            ...
            : base(163, 3, 6, 7)
        {
            ...
            this.m_b = FromBigInteger(new BigIntegerHttp(1, Hex.Decode("020A601907B8C953CA1481EB10512F78744A3205FD")));
            this.m_order = new BigIntegerHttp(1, Hex.Decode("040000000000000000000292FE77E70C12A4234C33"));
