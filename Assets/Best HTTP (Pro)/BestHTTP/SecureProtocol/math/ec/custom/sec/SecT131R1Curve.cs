...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
        ...
        : AbstractF2mCurve
    {
            ...
            : base(131, 2, 3, 8)
        {
            ...
            this.m_a = FromBigInteger(new BigIntegerHttp(1, Hex.Decode("07A11B09A76B562144418FF3FF8C2570B8")));
            this.m_b = FromBigInteger(new BigIntegerHttp(1, Hex.Decode("0217C05610884B63B9C6C7291678F9D341")));
            this.m_order = new BigIntegerHttp(1, Hex.Decode("0400000000000000023123953A9464B54D"));
