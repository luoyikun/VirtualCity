...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
        ...
        : AbstractF2mCurve
    {
        ...
        internal static readonly SecT571FieldElement SecT571R1_B = new SecT571FieldElement(
            new BigIntegerHttp(1, Hex.Decode("02F40E7E2221F295DE297117B7F3D62F5C6A97FFCB8CEFF1CD6BA8CE4A9A18AD84FFABBD8EFA59332BE7AD6756A66E294AFD185A78FF12AA520E4DE739BACA0C7FFEFF7F2955727A")));
            ...
            : base(571, 2, 5, 10)
        {
            ...
            this.m_a = FromBigInteger(BigIntegerHttp.One);
            this.m_b = SecT571R1_B;
            this.m_order = new BigIntegerHttp(1, Hex.Decode("03FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE661CE18FF55987308059B186823851EC7DD9CA1161DE93D5174D66E8382E9BB2FE84E47"));
