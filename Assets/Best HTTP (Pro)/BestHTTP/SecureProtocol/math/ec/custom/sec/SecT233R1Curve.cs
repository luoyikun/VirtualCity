...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
        ...
        : AbstractF2mCurve
    {
            ...
            : base(233, 74, 0, 0)
        {
            ...
            this.m_b = FromBigInteger(new BigIntegerHttp(1, Hex.Decode("0066647EDE6C332C7F8C0923BB58213B333B20E9CE4281FE115F7D8F90AD")));
            this.m_order = new BigIntegerHttp(1, Hex.Decode("01000000000000000000000000000013E974E72F8A6922031D2603CFE0D7"));
