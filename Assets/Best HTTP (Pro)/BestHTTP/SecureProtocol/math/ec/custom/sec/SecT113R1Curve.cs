...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
        ...
        : AbstractF2mCurve
    {
            ...
            : base(113, 9, 0, 0)
        {
            ...
            this.m_a = FromBigInteger(new BigIntegerHttp(1, Hex.Decode("003088250CA6E7C7FE649CE85820F7")));
            this.m_b = FromBigInteger(new BigIntegerHttp(1, Hex.Decode("00E8BEE4D3E2260744188BE0E9C723")));
            this.m_order = new BigIntegerHttp(1, Hex.Decode("0100000000000000D9CCEC8A39E56F"));
       ...
       public override bool IsKoblitz
        ...
        private ECFieldElement SolveQuadraticEquation(ECFieldElement beta)
        {
            ...
            ECFieldElement zeroElement = FromBigInteger(BigIntegerHttp.Zero);
            ...
            do
            {
                ECFieldElement t = FromBigInteger(new BigIntegerHttp(113, rand));
                z = zeroElement;
