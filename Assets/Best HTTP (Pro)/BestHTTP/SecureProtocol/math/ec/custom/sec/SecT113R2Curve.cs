...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
        ...
        : AbstractF2mCurve
    {
            ...
            : base(113, 9, 0, 0)
        {
            ...
            this.m_a = FromBigInteger(new BigIntegerHttp(1, Hex.Decode("00689918DBEC7E5A0DD6DFC0AA55C7")));
            this.m_b = FromBigInteger(new BigIntegerHttp(1, Hex.Decode("0095E9A9EC9B297BD4BF36E059184F")));
            this.m_order = new BigIntegerHttp(1, Hex.Decode("010000000000000108789B2496AF93"));
