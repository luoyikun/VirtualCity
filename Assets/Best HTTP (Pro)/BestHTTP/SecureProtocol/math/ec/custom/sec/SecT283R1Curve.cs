...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
        ...
        : AbstractF2mCurve
    {
            ...
            : base(283, 5, 7, 12)
        {
            ...
            this.m_b = FromBigInteger(new BigIntegerHttp(1, Hex.Decode("027B680AC8B8596DA5A4AF8A19A0303FCA97FD7645309FA2A581485AF6263E313B79A2F5")));
            this.m_order = new BigIntegerHttp(1, Hex.Decode("03FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEF90399660FC938A90165B042A7CEFADB307"));
