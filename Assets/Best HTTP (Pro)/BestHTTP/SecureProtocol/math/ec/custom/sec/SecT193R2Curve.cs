...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
        ...
        : AbstractF2mCurve
    {
            ...
            : base(193, 15, 0, 0)
        {
            ...
            this.m_a = FromBigInteger(new BigIntegerHttp(1, Hex.Decode("0163F35A5137C2CE3EA6ED8667190B0BC43ECD69977702709B")));
            this.m_b = FromBigInteger(new BigIntegerHttp(1, Hex.Decode("00C9BB9E8927D4D64C377E2AB2856A5B16E3EFB7F61D4316AE")));
            this.m_order = new BigIntegerHttp(1, Hex.Decode("010000000000000000000000015AAB561B005413CCD4EE99D5"));
