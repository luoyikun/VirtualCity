...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
        ...
        : AbstractF2mCurve
    {
            ...
            : base(193, 15, 0, 0)
        {
            ...
            this.m_a = FromBigInteger(new BigIntegerHttp(1, Hex.Decode("0017858FEB7A98975169E171F77B4087DE098AC8A911DF7B01")));
            this.m_b = FromBigInteger(new BigIntegerHttp(1, Hex.Decode("00FDFB49BFE6C3A89FACADAA7A1E5BBC7CC1C2E5D831478814")));
            this.m_order = new BigIntegerHttp(1, Hex.Decode("01000000000000000000000000C7F34A778F443ACC920EBA49"));
