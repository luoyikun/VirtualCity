...
namespace Org.BouncyCastle.Math.EC.Custom.Djb
{
    internal class Curve25519
        : AbstractFpCurve
    {
        public static readonly BigIntegerHttp q = Nat256.ToBigInteger(Curve25519Field.P);
            ...
            : base(q)
        {
            ...
            this.m_order = new BigIntegerHttp(1, Hex.Decode("1000000000000000000000000000000014DEF9DEA2F79CD65812631A5CF5D3ED"));
            this.m_cofactor = BigIntegerHttp.ValueOf(8);
