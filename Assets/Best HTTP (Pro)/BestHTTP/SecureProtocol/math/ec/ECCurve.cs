...
namespace Org.BouncyCastle.Math.EC
{
    ...
    public abstract class ECCurve
    {
        ...
        protected BigIntegerHttp m_order, m_cofactor;
        ...
        public abstract ECFieldElement FromBigInteger(BigIntegerHttp x);
        public abstract bool IsValidFieldElement(BigIntegerHttp x);
        ...
        public virtual ECPoint ValidatePoint(BigIntegerHttp x, BigIntegerHttp y)
        {
        ...
        public virtual ECPoint ValidatePoint(BigIntegerHttp x, BigIntegerHttp y, bool withCompression)
        {
        ...
        public virtual ECPoint CreatePoint(BigIntegerHttp x, BigIntegerHttp y)
        {
            return CreatePoint(x, y, false);
        }

        public virtual ECPoint CreatePoint(BigIntegerHttp x, BigIntegerHttp y, bool withCompression)
        {
        ...
        public virtual BigIntegerHttp Order
        {
            get { return m_order; }
        }

        public virtual BigIntegerHttp Cofactor
        {
        ...
        protected abstract ECPoint DecompressPoint(int yTilde, BigIntegerHttp X1);
        ...
        public virtual ECPoint DecodePoint(byte[] encoded)
        {
            ...
            switch (type)
            {
                ...
                case 0x03: // compressed
                {
                    ...
                    int yTilde = type & 1;
                    BigIntegerHttp X = new BigIntegerHttp(1, encoded, 1, expectedLength);
                ...
                case 0x04: // uncompressed
                {
                    ...
                    BigIntegerHttp X = new BigIntegerHttp(1, encoded, 1, expectedLength);
                    BigIntegerHttp Y = new BigIntegerHttp(1, encoded, 1 + expectedLength, expectedLength);
    ...
    public abstract class AbstractFpCurve
        : ECCurve
    {
        protected AbstractFpCurve(BigIntegerHttp q)
            : base(FiniteFields.GetPrimeField(q))
        {
        }

        public override bool IsValidFieldElement(BigIntegerHttp x)
        {
            return x != null && x.SignValue >= 0 && x.CompareTo(Field.Characteristic) < 0;
        }

        protected override ECPoint DecompressPoint(int yTilde, BigIntegerHttp X1)
        {
        ...
        : AbstractFpCurve
    {
        ...
        protected readonly BigIntegerHttp m_q, m_r;
        protected readonly FpPoint m_infinity;

        public FpCurve(BigIntegerHttp q, BigIntegerHttp a, BigIntegerHttp b)
            : this(q, a, b, null, null)
        {
        }

        public FpCurve(BigIntegerHttp q, BigIntegerHttp a, BigIntegerHttp b, BigIntegerHttp order, BigIntegerHttp cofactor)
            : base(q)
        {
            this.m_q = q;
        ...
        protected FpCurve(BigIntegerHttp q, BigIntegerHttp r, ECFieldElement a, ECFieldElement b)
            : this(q, r, a, b, null, null)
        {
        }

        protected FpCurve(BigIntegerHttp q, BigIntegerHttp r, ECFieldElement a, ECFieldElement b, BigIntegerHttp order, BigIntegerHttp cofactor)
            : base(q)
        {
            this.m_q = q;
            this.m_r = r;
    ...
    public abstract class AbstractF2mCurve
        : ECCurve
    {
        public static BigIntegerHttp Inverse(int m, int[] ks, BigIntegerHttp x)
        {
         ...
         * Koblitz curves.
         */
        private BigIntegerHttp[] si = null;
        ...
        public override ECPoint CreatePoint(BigIntegerHttp x, BigIntegerHttp y, bool withCompression)
        {
        ...
        private ECFieldElement SolveQuadradicEquation(ECFieldElement beta)
        {
            ...
            ECFieldElement gamma, z, zeroElement = FromBigInteger(BigIntegerHttp.Zero);

            int m = FieldSize;
            do
            {
                ECFieldElement t = FromBigInteger(BigIntegerHttp.Arbitrary(m));
                z = zeroElement;
         ...
         * Koblitz curves.
         */
        internal virtual BigIntegerHttp[] GetSi()
        {
            if (si == null)
            {
                lock (this)
        ...
        : AbstractF2mCurve
    {
        ...
        public F2mCurve(
            ...
            BigIntegerHttp	a,
            BigIntegerHttp	b,
            BigIntegerHttp	order,
            BigIntegerHttp	cofactor)
        ...
        protected F2mCurve(int m, int k1, int k2, int k3, ECFieldElement a, ECFieldElement b, BigIntegerHttp order, BigIntegerHttp cofactor)
            : base(m, k1, k2, k3)
        {
            this.m = m;
            this.k1 = k1;
