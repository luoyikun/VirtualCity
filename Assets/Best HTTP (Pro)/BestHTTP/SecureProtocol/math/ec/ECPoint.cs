...
namespace Org.BouncyCastle.Math.EC
{
    ...
    public abstract class ECPoint
    {
        ...
        protected static ECFieldElement[] GetInitialZCoords(ECCurve curve)
        {
            ...
            ECFieldElement one = curve.FromBigInteger(BigIntegerHttp.One);
        ...
        {
            BigIntegerHttp h = Curve.Cofactor;
            return h == null || h.Equals(BigIntegerHttp.One) || !ECAlgorithms.ReferenceMultiply(this, h).IsInfinity;
        }
        ...
        public abstract ECPoint Multiply(BigIntegerHttp b);
        ...
        : ECPoint
    {
         ...
         */
        public override ECPoint Multiply(BigIntegerHttp k)
        {
        ...
        : AbstractFpPoint
    {
        ...
        public override ECPoint Twice()
        {
            ...
            switch (coord)
            {
                ...
                case ECCurve.COORD_JACOBIAN:
                {
                    ...
                    ECFieldElement M, S;
                    if (a4Neg.ToBigInteger().Equals(BigIntegerHttp.ValueOf(3)))
                    {
        ...
        public override ECPoint TimesPow2(int e)
        {
            ...
            ECFieldElement X1 = this.RawXCoord;
            ECFieldElement Z1 = this.RawZCoords.Length < 1 ? curve.FromBigInteger(BigIntegerHttp.One) : this.RawZCoords[0];
            ...
            switch (coord)
            {
                ...
                case ECCurve.COORD_LAMBDA_PROJECTIVE:
                {
                    ...
                    if (X2.IsZero)
                    {
                        ...
                        Z3 = curve.FromBigInteger(BigIntegerHttp.One);
                    }
                    else
                    {
                        B = B.Square();
