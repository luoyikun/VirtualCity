...
namespace Org.BouncyCastle.Math.EC.Multiplier
{
    public abstract class WNafUtilities
    {
        ...
        public static int[] GenerateCompactNaf(BigIntegerHttp k)
        {
            if ((k.BitLength >> 16) != 0)
            ...
            BigIntegerHttp _3k = k.ShiftLeft(1).Add(k);

            int bits = _3k.BitLength;
            int[] naf = new int[bits >> 1];

            BigIntegerHttp diff = _3k.Xor(k);
        ...
        public static int[] GenerateCompactWindowNaf(int width, BigIntegerHttp k)
        {
            if (width == 2)
            {
        ...
        public static byte[] GenerateJsf(BigIntegerHttp g, BigIntegerHttp h)
        {
            int digits = System.Math.Max(g.BitLength, h.BitLength) + 1;
            byte[] jsf = new byte[digits];

            BigIntegerHttp k0 = g, k1 = h;
            int j = 0, d0 = 0, d1 = 0;
        ...
        public static byte[] GenerateNaf(BigIntegerHttp k)
        {
            if (k.SignValue == 0)
                return EMPTY_BYTES;
         ...
         */
        public static byte[] GenerateWindowNaf(int width, BigIntegerHttp k)
        {
            if (width == 2)
            {
        ...
        public static int GetNafWeight(BigIntegerHttp k)
        {
            if (k.SignValue == 0)
                return 0;
