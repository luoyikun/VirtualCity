...
namespace Org.BouncyCastle.Math.EC.Multiplier
{
    ...
    */
        ...
        : AbstractECMultiplier
    {
        ...
        */
        protected override ECPoint MultiplyPositive(ECPoint point, BigIntegerHttp k)
        {
        ...
        */
            ...
            PreCompInfo preCompInfo, sbyte a, sbyte mu)
        {
            ...
            BigIntegerHttp tw = Tnaf.GetTw(mu, Tnaf.Width);

            sbyte[]u = Tnaf.TauAdicWNaf(mu, lambda, Tnaf.Width,
                BigIntegerHttp.ValueOf(Tnaf.Pow2Width), tw, alpha);
