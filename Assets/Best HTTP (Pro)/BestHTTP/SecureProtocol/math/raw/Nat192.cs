...
namespace Org.BouncyCastle.Math.Raw
{
    internal abstract class Nat192
    {
        ...
        public static uint[] FromBigInteger(BigIntegerHttp x)
        {
        ...
        public static ulong[] FromBigInteger64(BigIntegerHttp x)
        {
            if (x.SignValue < 0 || x.BitLength > 192)
                throw new ArgumentException();
        ...
        public static BigIntegerHttp ToBigInteger(uint[] x)
        {
            byte[] bs = new byte[24];
            for (int i = 0; i < 6; ++i)
            {
            ...
            return new BigIntegerHttp(1, bs);
        }

        public static BigIntegerHttp ToBigInteger64(ulong[] x)
        {
            byte[] bs = new byte[24];
            for (int i = 0; i < 3; ++i)
            {
