...
namespace Org.BouncyCastle.Asn1.X9
{
    ...
    public sealed class X962NamedCurves
    {
            ...
            : X9ECParametersHolder
        {
            ...
            {
                BigIntegerHttp n = new BigIntegerHttp("ffffffffffffffffffffffff99def836146bc9b1b4d22831", 16);
                BigIntegerHttp h = BigIntegerHttp.One;

                ECCurve cFp192v1 = new FpCurve(
                    new BigIntegerHttp("6277101735386680763835789423207666416083908700390324961279"),
                    new BigIntegerHttp("fffffffffffffffffffffffffffffffefffffffffffffffc", 16),
                    new BigIntegerHttp("64210519e59c80e70fa7e9ab72243049feb8deecc146b9b1", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("fffffffffffffffffffffffe5fb1a724dc80418648d8dd31", 16);
                BigIntegerHttp h = BigIntegerHttp.One;

                ECCurve cFp192v2 = new FpCurve(
                    new BigIntegerHttp("6277101735386680763835789423207666416083908700390324961279"),
                    new BigIntegerHttp("fffffffffffffffffffffffffffffffefffffffffffffffc", 16),
                    new BigIntegerHttp("cc22d6dfb95c6b25e49c0d6364a4e5980c393aa21668d953", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("ffffffffffffffffffffffff7a62d031c83f4294f640ec13", 16);
                BigIntegerHttp h = BigIntegerHttp.One;

                ECCurve cFp192v3 = new FpCurve(
                    new BigIntegerHttp("6277101735386680763835789423207666416083908700390324961279"),
                    new BigIntegerHttp("fffffffffffffffffffffffffffffffefffffffffffffffc", 16),
                    new BigIntegerHttp("22123dc2395a05caa7423daeccc94760a7d462256bd56916", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("7fffffffffffffffffffffff7fffff9e5e9a9f5d9071fbd1522688909d0b", 16);
                BigIntegerHttp h = BigIntegerHttp.One;

                ECCurve cFp239v1 = new FpCurve(
                    new BigIntegerHttp("883423532389192164791648750360308885314476597252960362792450860609699839"),
                    new BigIntegerHttp("7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc", 16),
                    new BigIntegerHttp("6b016c3bdcf18941d0d654921475ca71a9db2fb27d1d37796185c2942c0a", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("7fffffffffffffffffffffff800000cfa7e8594377d414c03821bc582063", 16);
                BigIntegerHttp h = BigIntegerHttp.One;

                ECCurve cFp239v2 = new FpCurve(
                    new BigIntegerHttp("883423532389192164791648750360308885314476597252960362792450860609699839"),
                    new BigIntegerHttp("7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc", 16),
                    new BigIntegerHttp("617fab6832576cbbfed50d99f0249c3fee58b94ba0038c7ae84c8c832f2c", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("7fffffffffffffffffffffff7fffff975deb41b3a6057c3c432146526551", 16);
                BigIntegerHttp h = BigIntegerHttp.One;

                ECCurve cFp239v3 = new FpCurve(
                    new BigIntegerHttp("883423532389192164791648750360308885314476597252960362792450860609699839"),
                    new BigIntegerHttp("7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc", 16),
                    new BigIntegerHttp("255705fa2a306654b1f4cb03d6a750a30c250102d4988717d9ba15ab6d3e", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("ffffffff00000000ffffffffffffffffbce6faada7179e84f3b9cac2fc632551", 16);
                BigIntegerHttp h = BigIntegerHttp.One;

                ECCurve cFp256v1 = new FpCurve(
                    new BigIntegerHttp("115792089210356248762697446949407573530086143415290314195533631308867097853951"),
                    new BigIntegerHttp("ffffffff00000001000000000000000000000000fffffffffffffffffffffffc", 16),
                    new BigIntegerHttp("5ac635d8aa3a93e7b3ebbd55769886bc651d06b0cc53b0f63bce3c3e27d2604b", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("0400000000000000000001E60FC8821CC74DAEAFC1", 16);
                BigIntegerHttp h = BigIntegerHttp.Two;

                ECCurve c2m163v1 = new F2mCurve(
                    163,
                    1, 2, 8,
                    new BigIntegerHttp("072546B5435234A422E0789675F432C89435DE5242", 16),
                    new BigIntegerHttp("00C9517D06D5240D3CFF38C74B20B6CD4D6F9DD4D9", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("03FFFFFFFFFFFFFFFFFFFDF64DE1151ADBB78F10A7", 16);
                BigIntegerHttp h = BigIntegerHttp.Two;

                ECCurve c2m163v2 = new F2mCurve(
                    163,
                    1, 2, 8,
                    new BigIntegerHttp("0108B39E77C4B108BED981ED0E890E117C511CF072", 16),
                    new BigIntegerHttp("0667ACEB38AF4E488C407433FFAE4F1C811638DF20", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("03FFFFFFFFFFFFFFFFFFFE1AEE140F110AFF961309", 16);
                BigIntegerHttp h = BigIntegerHttp.Two;

                ECCurve c2m163v3 = new F2mCurve(
                    163,
                    1, 2, 8,
                    new BigIntegerHttp("07A526C63D3E25A256A007699F5447E32AE456B50E", 16),
                    new BigIntegerHttp("03F7061798EB99E238FD6F1BF95B48FEEB4854252B", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("010092537397ECA4F6145799D62B0A19CE06FE26AD", 16);
                BigIntegerHttp h = BigIntegerHttp.ValueOf(0xFF6E);

                ECCurve c2m176w1 = new F2mCurve(
                    176,
                    1, 2, 43,
                    new BigIntegerHttp("00E4E6DB2995065C407D9D39B8D0967B96704BA8E9C90B", 16),
                    new BigIntegerHttp("005DDA470ABE6414DE8EC133AE28E9BBD7FCEC0AE0FFF2", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("40000000000000000000000004A20E90C39067C893BBB9A5", 16);
                BigIntegerHttp h = BigIntegerHttp.Two;

                ECCurve c2m191v1 = new F2mCurve(
                    191,
                    9,
                    new BigIntegerHttp("2866537B676752636A68F56554E12640276B649EF7526267", 16),
                    new BigIntegerHttp("2E45EF571F00786F67B0081B9495A3D95462F5DE0AA185EC", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("20000000000000000000000050508CB89F652824E06B8173", 16);
                BigIntegerHttp h = BigIntegerHttp.ValueOf(4);

                ECCurve c2m191v2 = new F2mCurve(
                    191,
                    9,
                    new BigIntegerHttp("401028774D7777C7B7666D1366EA432071274F89FF01E718", 16),
                    new BigIntegerHttp("0620048D28BCBD03B6249C99182B7C8CD19700C362C46A01", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("155555555555555555555555610C0B196812BFB6288A3EA3", 16);
                BigIntegerHttp h = BigIntegerHttp.ValueOf(6);

                ECCurve c2m191v3 = new F2mCurve(
                    191,
                    9,
                    new BigIntegerHttp("6C01074756099122221056911C77D77E77A777E7E7E77FCB", 16),
                    new BigIntegerHttp("71FE1AF926CF847989EFEF8DB459F66394D90F32AD3F15E8", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("0101BAF95C9723C57B6C21DA2EFF2D5ED588BDD5717E212F9D", 16);
                BigIntegerHttp h = BigIntegerHttp.ValueOf(0xFE48);

                ECCurve c2m208w1 = new F2mCurve(
                    208,
                    1, 2, 83,
                    new BigIntegerHttp("0", 16),
                    new BigIntegerHttp("00C8619ED45A62E6212E1160349E2BFA844439FAFC2A3FD1638F9E", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("2000000000000000000000000000000F4D42FFE1492A4993F1CAD666E447", 16);
                BigIntegerHttp h = BigIntegerHttp.ValueOf(4);

                ECCurve c2m239v1 = new F2mCurve(
                    239,
                    36,
                    new BigIntegerHttp("32010857077C5431123A46B808906756F543423E8D27877578125778AC76", 16),
                    new BigIntegerHttp("790408F2EEDAF392B012EDEFB3392F30F4327C0CA3F31FC383C422AA8C16", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("1555555555555555555555555555553C6F2885259C31E3FCDF154624522D", 16);
                BigIntegerHttp h = BigIntegerHttp.ValueOf(6);

                ECCurve c2m239v2 = new F2mCurve(
                    239,
                    36,
                    new BigIntegerHttp("4230017757A767FAE42398569B746325D45313AF0766266479B75654E65F", 16),
                    new BigIntegerHttp("5037EA654196CFF0CD82B2C14A2FCF2E3FF8775285B545722F03EACDB74B", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("0CCCCCCCCCCCCCCCCCCCCCCCCCCCCCAC4912D2D9DF903EF9888B8A0E4CFF", 16);
                BigIntegerHttp h = BigIntegerHttp.ValueOf(10);

                ECCurve c2m239v3 = new F2mCurve(
                    239,
                    36,
                    new BigIntegerHttp("01238774666A67766D6676F778E676B66999176666E687666D8766C66A9F", 16),
                    new BigIntegerHttp("6A941977BA9F6A435199ACFC51067ED587F519C5ECB541B8E44111DE1D40", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("0100FAF51354E0E39E4892DF6E319C72C8161603FA45AA7B998A167B8F1E629521", 16);
                BigIntegerHttp h = BigIntegerHttp.ValueOf(0xFF06);

                ECCurve c2m272w1 = new F2mCurve(
                    272,
                    1, 3, 56,
                    new BigIntegerHttp("0091A091F03B5FBA4AB2CCF49C4EDD220FB028712D42BE752B2C40094DBACDB586FB20", 16),
                    new BigIntegerHttp("7167EFC92BB2E3CE7C8AAAFF34E12A9C557003D7C73A6FAF003F99F6CC8482E540F7", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("0101D556572AABAC800101D556572AABAC8001022D5C91DD173F8FB561DA6899164443051D", 16);
                BigIntegerHttp h = BigIntegerHttp.ValueOf(0xFE2E);

                ECCurve c2m304w1 = new F2mCurve(
                    304,
                    1, 2, 11,
                    new BigIntegerHttp("00FD0D693149A118F651E6DCE6802085377E5F882D1B510B44160074C1288078365A0396C8E681", 16),
                    new BigIntegerHttp("00BDDB97E555A50A908E43B01C798EA5DAA6788F1EA2794EFCF57166B8C14039601E55827340BE", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("01AF286BCA1AF286BCA1AF286BCA1AF286BCA1AF286BC9FB8F6B85C556892C20A7EB964FE7719E74F490758D3B", 16);
                BigIntegerHttp h = BigIntegerHttp.ValueOf(0x4C);

                ECCurve c2m359v1 = new F2mCurve(
                    359,
                    68,
                    new BigIntegerHttp("5667676A654B20754F356EA92017D946567C46675556F19556A04616B567D223A5E05656FB549016A96656A557", 16),
                    new BigIntegerHttp("2472E2D0197C49363F1FE7F5B6DB075D52B6947D135D8CA445805D39BC345626089687742B6329E70680231988", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("010090512DA9AF72B08349D98A5DD4C7B0532ECA51CE03E2D10F3B7AC579BD87E909AE40A6F131E9CFCE5BD967", 16);
                BigIntegerHttp h = BigIntegerHttp.ValueOf(0xFF70);

                ECCurve c2m368w1 = new F2mCurve(
                    368,
                    1, 2, 85,
                    new BigIntegerHttp("00E0D2EE25095206F5E2A4F9ED229F1F256E79A0E2B455970D8D0D865BD94778C576D62F0AB7519CCD2A1A906AE30D", 16),
                    new BigIntegerHttp("00FC1217D4320A90452C760A58EDCD30C8DD069B3C34453837A34ED50CB54917E1C2112D84D164F444F8F74786046A", 16),
                    n, h);
            ...
            : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigIntegerHttp n = new BigIntegerHttp("0340340340340340340340340340340340340340340340340340340323C313FAB50589703B5EC68D3587FEC60D161CC149C1AD4A91", 16);
                BigIntegerHttp h = BigIntegerHttp.ValueOf(0x2760);

                ECCurve c2m431r1 = new F2mCurve(
                    431,
                    120,
                    new BigIntegerHttp("1A827EF00DD6FC0E234CAF046C6A5D8A85395B236CC4AD2CF32A0CADBDC9DDF620B0EB9906D0957F6C6FEACD615468DF104DE296CD8F", 16),
                    new BigIntegerHttp("10D9B4A3D9047D8B154359ABFB1B7F5485B04CEB868237DDC9DEDA982A679A5A919B626D4E50A8DD731B107A9962381FB5D807BF2618", 16),
                    n, h);
