...
namespace Org.BouncyCastle.Asn1.X509
{
		...
		: Asn1Encodable
	{
		...
		internal SubjectPublicKeyInfoHttp    subjectPublicKeyInfo;
			...
			Asn1Sequence seq)
		{
			...
			// public key info.
			//
			subjectPublicKeyInfo = SubjectPublicKeyInfoHttp.GetInstance(seq[seqStart + 6]);
		...
		public SubjectPublicKeyInfoHttp SubjectPublicKeyInfo
		{
